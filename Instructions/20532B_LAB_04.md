...
* Use the Visual Studio Server Explorer to view live data in the cloud.
...
3. Click on **Manage allowed IP Addresses**.

4. Add the current client IP address to the allowed addresses and save the firewall settings.

5. Open the **Server Explorer** window in Visual Studio

6. Add a new Data Connection using the following values:

  - Server name: **sv20532[your name].database.windows.net**

  - Username: **testuser**

  - Password: **TestPa\$\$w0rd**

  - Database name: **db20532[your name]**

7. View the data in the **dbo.Events** table.
