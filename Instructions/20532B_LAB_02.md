...
2. Navigate to **Virtual Machines** and choose **Windows Server 2012 R2 Datacenter**

3. Create a virtual machine by using the following details:
...
4. Add a second disk to the virtual machine by using the following settings:
...
5. Connect to the newly created virtual machine by using Remote Desktop.
