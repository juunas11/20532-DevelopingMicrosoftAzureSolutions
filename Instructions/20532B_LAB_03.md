...
1. Create a Web App instance by using the Management Portal.
...
2.  Create a new Custom Web App instance by using a unique name and the following details:
  ...
  * Url: **Pick a unique name for the Web App**
...
1.  View the Dashboard for your Web App.

2.  Go to your new Web App.

> **Results**: After completing this exercise, you will have used the Management Portal to create Web App instances.
...
1. Sign in to the Management Portal ([*https://manage.windowsazure.com*](https://manage.windowsazure.com)).

2. Go to your previously created Web App’s dashboard.

3. Download the publish profile for your Web App:
...
2. Go to your previously created Web App’s **Configure** tab.
